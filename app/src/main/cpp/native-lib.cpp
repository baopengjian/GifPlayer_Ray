...
Java_bpj_com_gifplayer_1ray_GifHandler_loadPath(JNIEnv *env, jobject instance, jstring path_) {
...
Java_bpj_com_gifplayer_1ray_GifHandler_getWidth__J(JNIEnv *env, jobject instance, jlong ndkGif) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_bpj_com_gifplayer_1ray_GifHandler_getHeight__J(JNIEnv *env, jobject instance, jlong ndkGif) {
    GifFileType* gifFileType= (GifFileType *) ndkGif;
...
extern "C"
JNIEXPORT jint JNICALL
Java_bpj_com_gifplayer_1ray_GifHandler_updateFrame__JLandroid_graphics_Bitmap_2(JNIEnv *env,
                                                                                jobject instance,
                                                                                jlong ndkGif,
                                                                                jobject bitmap) {
